...
# SECURITY: without this the desktop sidecar's wildcard CORS is exposed to the
...
# OPENCODE_SERVER_CORS is read by the patched app.asar to restrict the sidecar's
# CORS allowlist to the funnel URL + oc://renderer, instead of wildcard "*".
